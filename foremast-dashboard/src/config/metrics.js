...
export const Y_METRIC_NAME = 'namespace_app_pod_http_server_requests_error_5xx';
...
export const METRICS_MAP = {
  'namespace_app_pod_http_server_requests_error_5xx': {
    commonName: '5XX Errors',
    metrics: [{
      type: BASE,
      name: 'namespace_app_pod_http_server_requests_error_5xx',
      namespace_key: 'namespace',
    }, {
      type: UPPER,
      name: 'foremastbrain:namespace_app_pod_http_server_requests_error_5xx_upper',
      namespace_key: 'exported_namespace',
    }, {
      type: LOWER,
      name: 'foremastbrain:namespace_app_pod_http_server_requests_error_5xx_lower',
      namespace_key: 'exported_namespace',
    }, {
      type: ANOMALY,
      name: 'foremastbrain:namespace_app_pod_http_server_requests_error_5xx_anomaly',
      namespace_key: 'exported_namespace',
    }],
