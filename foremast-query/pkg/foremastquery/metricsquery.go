...
//	createMetricsInfo(namespace string, appName string, podNames [][]string, metrics Metrics) (MetricsInfo, error)
//}
...
func createMap(namespace string, appName string, podNames []string, metrics Metrics, category string, timeWindow time.Duration, strategy string) (map[string]MetricQuery, error) {
